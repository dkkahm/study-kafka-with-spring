...
public class Hello extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8092116222751577907L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Hello\",\"namespace\":\"com.example.avro.data\",\"doc\":\"Hello world avro\",\"fields\":[{\"name\":\"myStringField\",\"type\":\"string\",\"doc\":\"Just a string\"},{\"name\":\"myIntField\",\"type\":\"int\",\"doc\":\"Just a int\"}]}");
   ...
   */
  public static com.example.avro.data.Hello.Builder newBuilder() {
    return new com.example.avro.data.Hello.Builder();
  }
   ...
   * @return A new Hello RecordBuilder
   */
  public static com.example.avro.data.Hello.Builder newBuilder(com.example.avro.data.Hello.Builder other) {
    if (other == null) {
      return new com.example.avro.data.Hello.Builder();
    } else {
      return new com.example.avro.data.Hello.Builder(other);
    }
  }
   ...
   * @return A new Hello RecordBuilder
   */
  public static com.example.avro.data.Hello.Builder newBuilder(com.example.avro.data.Hello other) {
    if (other == null) {
      return new com.example.avro.data.Hello.Builder();
    } else {
      return new com.example.avro.data.Hello.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Hello>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.avro.data.Hello.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.avro.data.Hello other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.myStringField)) {
        this.myStringField = data().deepCopy(fields()[0].schema(), other.myStringField);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.data.Hello.Builder setMyStringField(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.data.Hello.Builder clearMyStringField() {
      myStringField = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.data.Hello.Builder setMyIntField(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.data.Hello.Builder clearMyIntField() {
